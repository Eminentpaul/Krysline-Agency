...
class User(AbstractUser):
    ...
    user_type = models.CharField(
        max_length=25, choices=USER_TYPE, default='affiliate')
...
class UserProfile(models.Model):
    ...
    bank = models.CharField(
        max_length=100, choices=BANKS, null=True, blank=True)
    ...
    kyc_document_number = models.CharField(
        max_length=100, blank=True, null=True)  # Or EncryptedField
